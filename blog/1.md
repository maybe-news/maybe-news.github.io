...
跟[上次介绍](https://xiaogaozi.me/blog/2020/04/26/weekly-reading-list-issue-1)的 FoundationDB Record Layer 一样，这篇来自京东团队的论文也是发表在 SIGMOD 2019，介绍了一个为大规模容器平台设计的分布式文件系统。
